...
const CLIENT_ID =
  process.env.NODE_ENV === 'production'
    ...
    : 'bbb05da9a8a9443ab28491d8c95fa35f'

const SPOTIFY_SECRET =
  process.env.NODE_ENV === 'production'
    ? process.env.SPOTIFY_SECRET
    : '97cc1a9288404c37ac39ec5763e1bdbe'
...
const defaultOptions = {
  ...
  access_key: process.env.MPLAY_ACCESS_KEY,
  access_secret: process.env.MPLAY_ACCESS_SECRET,
}
